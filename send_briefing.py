...
def markdown_to_html(md_text: str, subject: str) -> str:
    """Convert the briefing's Markdown into a simple, clean styled HTML email."""
...
<style>
  ...
  h2 {{ font-size: 17px; margin-top: 28px; color: #111; }}
...
def send_email(subject: str, body: str) -> None:
    ...
    # Plain-text fallback first, HTML second (email clients prefer the last part)
    msg.attach(MIMEText(body, "plain", "utf-8"))
    msg.attach(MIMEText(markdown_to_html(body, subject), "html", "utf-8"))
